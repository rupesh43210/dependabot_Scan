# Dependabot/Security Pipeline Launcher
# Automatically activates venv and runs the security pipeline
...
Write-Host "🛡️  Security Pipeline Launcher" -ForegroundColor Cyan
...
# Build command
$command = "python security_pipeline.py"
